    ...
    return (
        <div className="max-w-lg p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="flex my-4 justify-between">
                ...
                <div className="border border-gray-200 p-5 justify-center">
                    <h5 className='text-center'>Sunrise</h5>
                    <div className="mt-3">
                        <svg  xmlns="http://www.w3.org/2000/svg" width="100%" height="60" viewBox="0 0 64 64">
                ...
                <div className="border border-gray-200 p-5">
                    ...
                    <div className="mt-3">
                        <img className="mx-auto" src='/sunset-svgrepo-com.svg' />
                    </div>
