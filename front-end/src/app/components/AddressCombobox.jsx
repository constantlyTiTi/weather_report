...
const AddressCombobox = () => {
  ...
  }, [selectedCity, cityOptionsByProv])
  ...
  return (
    <>
      <div className="relative" onBlur={onBlur}>
        <input value={selectedCity} onChange={(e) => inputOnChange(e)} onClick={() => setIsOpenDropDown(!isOpenDropDown)} className="w-full py-2 px-4 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" type="search" placeholder="Search" />
